                        ...
                        <li class="nav-item menu-open ">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview sub-menu">
                                    <li class="nav-item"><a href="<?php echo e(route('create_product')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i> បង្កើតមុខទំនិញថ្មី</a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview sub-menu">
                                    ...
                                    <li class="nav-item"><a href="" class="nav-link"><i class="far fa-circle nav-icon"></i> អ្នកផ្គត់ផ្គង់</a></li>
